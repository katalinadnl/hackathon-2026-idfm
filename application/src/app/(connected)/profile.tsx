  ...
  return (
    <View style={styles.screen}>
      <SafeAreaView edges={Platform.OS === 'web' ? [] : ['top']} style={styles.safe}>
        ...
        <View style={{ paddingHorizontal: DS.space5, paddingBottom: BottomTabInset + DS.space6 }}>
          <Button
            variant="danger"
            size="lg"
            fullWidth
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '800', color: DS.textStrong, letterSpacing: -0.5 },
  ...
  rowValue: { fontSize: 15, color: DS.textStrong, fontWeight: '600', flexShrink: 1, textAlign: 'right' },
