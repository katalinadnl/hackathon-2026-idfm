...
const TRAFFIC_STATUS = [
  ...
  { mode: 'rer' as const, line: 'A', status: 'major' as const, message: "Interrompu Châtelet ↔ Nation jusqu'à 18h." },
  { mode: 'rer' as const, line: 'B', status: 'minor' as const, message: "Temps d'attente prolongés." },
  { mode: 'metro' as const, line: 4, status: 'normal' as const },
  { mode: 'metro' as const, line: 6, status: 'minor' as const, message: 'Trafic ralenti, travaux.' },
];

const JOURNEY_RESULTS = [
  {
    depart: '08:04', arrive: '08:27', duration: '23 min',
    recommended: true, accessible: true,
    legs: [{ walk: 4 }, { mode: 'metro', line: 1 }, { mode: 'rer', line: 'A' }, { walk: 3 }],
  },
  {
    depart: '08:09', arrive: '08:38', duration: '29 min',
    legs: [{ walk: 2 }, { mode: 'metro', line: 14 }, { mode: 'metro', line: 6 }, { walk: 5 }],
  },
  {
    depart: '08:12', arrive: '08:44', duration: '32 min',
    accessible: true,
    legs: [{ walk: 6 }, { mode: 'bus', line: '91' }, { mode: 'metro', line: 4 }, { walk: 2 }],
  },
];
    ...
    >
      <SafeAreaView edges={Platform.OS === 'web' ? [] : ['top']}>
            ...
            <Card style={[styles.plannerCard, isDesktop && styles.plannerCardDesktop]}>
              ...
              {isDesktop ? (
                <View style={styles.routeRowDesktop}>
                  ...
                  >
                    <Icon name="arrow-up-down" size={22} color={DS.actionPrimary} />
                  </Pressable>
                  <View style={styles.routeInputDesktop}>
                    <Input
                      label={t('to_label')}
                ...
                <View style={styles.routeRow}>
                  ...
                  <Pressable
                    ...
                    accessibilityLabel={t('swap_label')}
                  >
                    <Icon name="swap-vertical" size={22} color={DS.actionPrimary} />
                  </Pressable>
                </View>
              )}

              {/* PMR switch + search */}
              <View style={[styles.plannerFooter, isDesktop && styles.plannerFooterDesktop]}>
                <View style={styles.pmrRow} accessible accessibilityLabel={t('accessible_label')}>
                  <Switch
                    value={pmr}
                    onValueChange={setPmr}
                    trackColor={{ false: DS.borderDefault, true: DS.actionPrimary }}
                    thumbColor={DS.white}
        ...
        <View style={isDesktop ? pageInner : undefined}>
          ...
          {searched && (
            <View style={[styles.section, sectionPad]} accessibilityLiveRegion="polite">
            ...
            <View style={[styles.grid, isDesktop && styles.gridFour]}>
              {POPULAR_DESTINATIONS.map((p, i) => (
                ...
                >
                  ...
                  <Text style={styles.destMeta}>{p.mins} · {t('from_your_position')}</Text>
                </Card>
              ))}
            </View>
          </View>
        ...
        <View style={styles.footer} accessible accessibilityRole="none">
          <View style={[styles.footerInner, isDesktop && styles.footerInnerDesktop]}>
            ...
            <View style={[styles.footerLinks, isDesktop && styles.footerLinksDesktop]}>
              {[
                [t('footer_itineraires'), t('footer_plans'), t('footer_horaires'), t('footer_accessibilite')],
                [t('footer_navigo'), t('footer_ticket_simple'), t('footer_tarifs_reduits'), t('footer_remboursement')],
                [t('footer_contact'), t('footer_objets'), t('footer_faq'), t('accessibility_statement')],
              ].map((col, ci) => (
