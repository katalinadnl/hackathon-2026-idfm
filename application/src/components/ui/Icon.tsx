...
const SYMBOL_MAP: Record<string, { ios: string; android: string; web: string }> = {
  ...
  accessibility:    { ios: 'figure.roll',               android: 'accessibility',       web: 'accessibility' },
  'arrow-up-down':  { ios: 'arrow.up.arrow.down',       android: 'swap_vert',           web: 'swap_vert' },
  'swap-vertical':  { ios: 'arrow.up.arrow.down',       android: 'swap_vert',           web: 'swap_vert' },
  ...
  'log-out':        { ios: 'rectangle.portrait.and.arrow.right', android: 'logout',     web: 'logout' },
